...
<#if MC.DRIVE_TYPE == "FOC" | MC.ACIM_CONFIG == "LSO_FOC">
...
<#if MC.DRIVE_TYPE == "SIX_STEP">
  ...
  <#else> 
  .MaxPositiveDutyCycle =             (uint16_t)PERIODMAX_REF/2,
  </#if> 
...
ACIM_LSO_Handle_t ACIM_LSO_Component_M1 = 
{
  ...
  .bElToMecRatio                       =	POLE_PAIR_NUM,             /*!< Coefficient used to transform electrical to
    ...
    .hMaxReliableMecSpeedUnit          =	(uint16_t)(1.15*MAX_APPLICATION_SPEED_UNIT), /*!< Maximum value of measured speed that is
