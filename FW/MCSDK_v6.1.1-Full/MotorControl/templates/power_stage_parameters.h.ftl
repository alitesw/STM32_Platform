...
#define BEMF_ON_SENSING_DIVIDER		 ${MC.BEMF_ON_SENSING_DIVIDER}		/*!< BEMF voltage divider during PWM ON time for zero crossing detection */
</#if>													 
...
#define AMPLIFICATION_GAIN            ${MC.AMPLIFICATION_GAIN}
  <#if MC.DRIVE_MODE == "CM">
