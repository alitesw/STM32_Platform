...
#define  MC_REG_PERF_CPU_LOAD          ((106  << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT )
#define  MC_REG_PERF_MIN_CPU_LOAD      ((107  << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT )
#define  MC_REG_PERF_MAX_CPU_LOAD      ((108  << ELT_IDENTIFIER_POS) | TYPE_DATA_32BIT )
</#if>
</#if>
