...
<#-- <#function _first_word text sep="-"><#return text?split(sep)?first></#function> -->
  ...
  <#elseif STM32303E_EVALCond == true>
    ...
    <#assign BoardEnable_Pin  = "2">
  <#if MC.DUALDRIVE == true && MC.M1_ICL_ENABLED == false && MC.ON_OVER_VOLTAGE != "TURN_ON_R_BRAKE"> 
